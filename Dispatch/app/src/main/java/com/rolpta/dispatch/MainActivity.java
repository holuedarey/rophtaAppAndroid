...
public class MainActivity extends AppCompatActivity implements IPickResult {
    ...
    public static String APIURL="https://zapi.rolpta.com/";
    ...
    public void popup_url(String url) {
        Intent callIntent = new Intent(Intent.ACTION_VIEW,  Uri.parse(url));
        startActivity(callIntent);
    }


    public void send_mail(String url) {

        Utils.log("Attempt sending email to "+url);
